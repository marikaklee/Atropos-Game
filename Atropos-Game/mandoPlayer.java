...
public class mandoPlayer {
	...
	*/
	private static boolean isSafe(int[][] board, int color, int x, int y) {
		...
		// Check each triangle to see if it forms a losing triangle
		// Because Red = 1, Green = 2, and Blue = 3 
		// If the three colors are present in this triangle, the sum must be 6
		// Hence if 6 - vertex1 - vertex2 == color, it means the player loses
